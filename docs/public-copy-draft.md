...
Status: draft. Do not publish until the fact checks at the end of this file
are complete.
...
- "Elite team" unless the team composition is documented.
- "Tokyo core team" unless there is a real team and operating model behind it.
- "Outsourcing to China" as public wording.
- "Discount" as a headline message.
- Any absolute guarantee about compliance handling.

## English Homepage Draft
...
- Documentation and handover built into delivery

### Closing Line

Senior engineering where trust matters. Flexible delivery where efficiency
matters.

## Chinese Audience Page Draft
...
不是所有工作都应该使用同一种交付模式。高敏感、高责任归属的工作保持更严格的处理方式；低敏感、边界清晰的工作可以在明确规则下优化成本。
